...
const DEMO_EMAIL    = 'demo@socialpulse.io'
...
export default function Login() {
    ...
    return (
                ...
                <div className="login-brand">
                    <div className="login-brand-icon">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                            <path d="M22 12h-4l-3 9L9 3l-3 9H2" stroke="var(--accent-teal)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                    </div>
                    <span className="login-brand-name">SocialPulse</span>
                </div>
            ...
            <main className="login-main">
                <div className="login-logo">
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
                        <rect width="24" height="24" rx="8" fill="url(#lg)"/>
                        <defs>
                        ...
                        <path d="M7 15l3-6 3 4 2-3 2 5" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                </div>

                <h1 className="login-title">Welcome back</h1>
                <p className="login-subtitle">Sign in to your SocialPulse workspace</p>
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                        <div className="field-group">
                            ...
                            <input
                                ...
                                placeholder="demo@socialpulse.io"
                                autoComplete="email"
                            />
                        </div>
                ...
                <div className="demo-card">
                    ...
                    <button className="fill-btn" onClick={fillDemo}>Fill in</button>
                </div>
            </main>

            <footer className="login-footer">
                © 2026 SocialPulse Analytics. All rights reserved.
            </footer>
        ...
        .login-logo {
          ...
          justify-content: center;
          margin-bottom: 20px;
          box-shadow: 0 0 0 1px var(--border), 0 8px 24px rgba(247,37,133,0.15);
        ...
        .forgot-btn:hover { color: var(--text-primary); }
        ...
        .demo-title { font-size: 12px; font-weight: 500; color: var(--text-secondary); margin-bottom: 2px; }
        .demo-value { font-size: 12px; color: var(--text-muted); font-family: monospace; }
        .fill-btn {
          background: var(--bg-elevated);
          border: 1px solid var(--border);
          border-radius: var(--radius-md);
        ...
        .fill-btn:hover { border-color: var(--accent-teal); background: var(--accent-teal-dim); }
        .login-footer {
          text-align: center;
          padding: 16px;
          font-size: 12px;
