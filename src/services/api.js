...
export const settingsAPI = {
  connectInstagram: (username, password) =>
    request("PUT", "/settings/connect-instagram", { username, password }),
  disconnectInstagram: () => request("PUT", "/settings/disconnect-instagram"),
  connectTiktok: (username) =>
    request("PUT", "/settings/connect-tiktok", { username }),
  updateProfile: (full_name) =>
    request("PUT", "/settings/update-profile", { full_name }),
  changePassword: (current_password, new_password) =>
    request("PUT", "/settings/change-password", {
      current_password,
      new_password,
    }),
};
